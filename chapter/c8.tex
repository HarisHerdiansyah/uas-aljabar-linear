...
\begin{enumerate}
	...
	\item Persamaan bidang dicari menggunakan rumus bentuk titik-normal:
	\[a(x - x_0) + b(y - y_0) + c(z - z_0) = 0\]
	Di mana:
	\begin{itemize}
		\item $(a,b,c)$ adalah vektor normal $\mathbf{n}=(-3,5,2)$
		\item $(x_0,y_0,z_0)$ adalah koordinat titik yang dilalui $P(2,-1,4)$
		\item Vektor normal sendiri adalah vektor yang posisinya tegak lurus terhadap suatu objek, objeknya dapat berupa bidang atau garis.
	\end{itemize}
	...
	\item Panjang proyeksi adalah nilai skalar yang menunjukkan besaran panjang bayangan tegak lurus suatu vektor pada garis yang searah dengan vektor lainnya.
	Persamaan untuk mencari panjang proyeksi:
	...
	\item
	Proyeksi vektor adalah bayangan suatu vektor terhadap vektor lain yang searah, misal $\text{proj}_{v}u$ berarti ingin dicari proyeksi (bayangan) vektor $\mathbf{u}$ yang searah dengan vektor $\mathbf{v}$.
